...
<head>
    ...
    <link rel="stylesheet" href={{asset("front/css/customScrollbar.css")}}>
                                                    ...
                                                    <div class="tg-cartcontent dropdown-menu" aria-labelledby="tg-cartdropdown">
                                                        <ul>
                                                            <li>
                                                                <figure>
                                                                    <a href="#">
                                                                        <img src={{asset("front/images/thumbnails/img-01.jpg")}} alt="image description">
                                                                    </a>
                                                                </figure>
                                                            ...
                                                            <li>
                                                                <figure>
                                                                    <a href="#">
                                                                        <img src={{asset("front/images/thumbnails/img-02.jpg")}} alt="image description">
                                                                    </a>
                                                                </figure>
                                                                <div class="tg-product-detail">
                                                                    <h3><a href="#">Smooth 3-Stripes Scarf</a></h3>
                                                            ...
                                                            <li>
                                                                <figure>
                                                                    <a href="#">
                                                                        <img src={{asset("front/images/thumbnails/img-03.jpg")}} alt="image description">
                                                                    </a>
                                                                </figure>
                                                                <div class="tg-product-detail">
                                                                    <h3><a href="#">Smooth 3-Stripes Scarf</a></h3>
                    ...
                    <nav id="tg-nav" class="tg-nav brand-center">
                        <div class="navbar-header">
                            ...
                            <strong class="tg-logo">
                                <a href="index-2.html"><img src={{asset("front/images/logo.png")}} alt="image description"></a>
                            </strong>
                        </div>
    ...
    *************************************-->
    <div class="tg-sliderbox">
        <div class="tg-imglayer">
            <img src={{asset("front/images/bg-pattran.png")}} alt="image desctription">
        </div>
        <div id="tg-home-slider" class="tg-home-slider tg-haslayout">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="container">
                        <figure class="floating">
                            <img src={{asset("front/images/slider/img-01.png")}} alt="image description">
                        </figure>
                ...
                <div class="swiper-slide">
                    <div class="container">
                        <figure class="floating">
                            <img src={{asset("front/images/slider/img-02.png")}} alt="image description">
                        </figure>
                        <div class="tg-slider-content">
                            <h1>alive and <span>kickin</span></h1>
                            <div class="tg-btnbox">
                        ...
                        <div class="tg-aboutussection">
                            <div class="row">
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <figure>
                                        <img src={{asset("front/images/img-01.jpg")}} alt="image description">
                                    </figure>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="tg-upcomingmatch-counter">
                            <div class="col-md-4 col-sm-4 col-xs-12 hidden-xs">
                                <figure>
                                    <img src={{asset("front/images/img-02.png")}} alt="image description">
                                </figure>
                            </div>
...
{{--                                                            <a href="#">--}}
{{--                                                                <img src={{asset("front/images/team-logo/logo-01.png")}} alt="image description">--}}
{{--                                                            </a>--}}
{{--                                                        </strong>--}}
...
{{--                                                        <strong class="tg-team-logo">--}}
{{--                                                            <a href="#">--}}
{{--                                                                <img src={{asset("front/images/team-logo/logo-02.png")}} alt="image description">--}}
{{--                                                            </a>--}}
{{--                                                        </strong>--}}
{{--                                                        <div class="tg-team-nameplusstatus">--}}
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div id="tg-matchscrollbar" class="tg-matchscrollbar tg-allmatchstatus">
                                        <ul class="tg-matchtabnav" role="tablist">
                                            @forelse($livescores as $livescore)
...
{{--                                                                <img src={{asset("front/images/team-logo/logo-s-01.png")}} alt="image description">--}}
{{--                                                            </strong>--}}


                                                            <h4>{{$livescore->scheduled}}&emsp;{{$livescore->time}}&emsp;{{$livescore->home_name}}</h4>
                                                        </div>
                                                        <div class="tg-box">

                                                            <h3>{{$livescore->score}}</h3>
                                                            <p style="margin: 0">{{$livescore->league_name}}</p>
                                                        </div>
                                                        <div class="tg-box">
{{--                                                            <strong class="tg-teamlogo">--}}
{{--                                                                <img src={{asset("front/images/team-logo/logo-s-01.png")}} alt="image description">--}}
{{--                                                            </strong>--}}
                                                            <h4>{{$livescore->away_name}}</h4>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="tg-match">
                                                    ...
                                                    <div class="tg-matchdetail">
                                                        <div class="tg-box">
                                                            <strong class="tg-teamlogo">
                                                                <img src={{asset("front/images/team-logo/logo-l-02.png")}} alt="image description">
                                                            </strong>
                                                            <h3>{{$fixture->home_name}}</h3>
                                                        </div>
                                                        <div class="tg-box">
                                                            <h3>vs</h3>
                                                        </div>
                                                        <div class="tg-box">
                                                            ...
                                                            <h3>{{$fixture->away_name}}</h3>
                                                        </div>
                                                    </div>
                                                    <div class="tg-matchhover">

{{--                                                        <address>Jan16, 2017 15:30 PM Soccer Stadium, Dubai--}}
                                                        <address>{{$fixture->date}} {{$fixture->time}}<br/> {{$fixture->location}}  </address>
                                                        <div class="tg-btnbox">
                                                            <a class="tg-btn" href="#"><span>read more</span></a>
                                                            <a class="tg-btn" href="#"><span>book my ticket</span></a>
                                                        </div>
...
{{--                                            --}}
        ...
        *************************************-->
        <section class="tg-videobox tg-haslayout">
            <figure>
                <img src={{asset("front/images/bg-video.jpg")}} alt="image description">
                <figcaption>
                                    ...
                                    <div id="tg-playerscrollbar" class="tg-players tg-playerscrollbar">
                                        <div class="tg-player">
                                            ...
                                            <div class="col-sm-6 col-xs-6">
                                                <figure>
                                                    <a href="#">
                                                        <img src={{asset("front/images/player/img-01.png")}} alt="image description">
                                                    </a>
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="tg-player">
                                            ...
                                            <div class="col-sm-6 col-xs-6">
                                                <figure>
                                                    <a href="#">
                                                        <img src={{asset("front/images/player/img-02.png")}} alt="image description">
                                                    </a>
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="tg-player">
                                            ...
                                            <div class="col-sm-6 col-xs-6">
                                                <figure>
                                                    <a href="#">
                                                        <img src={{asset("front/images/player/img-03.png")}} alt="image description">
                                                    </a>
                                                </figure>
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="tg-pointstablewrapper">
                            ...
                            <div class="col-sm-4 col-xs-12 hidden-xs">
                                <figure>
                                    <img src={{asset("front/images/img-03.png")}} alt="image description">
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-xs-12">
                                    <article class="tg-post">
                                        <figure class="tg-postimg">
                                            <a href="#">
                                                <img src={{asset("front/images/blog/img-01.jpg")}} alt="image description">
                                            </a>
                                            <figcaption>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <article class="tg-post">
                                        <figure class="tg-postimg">
                                            <a href="#">
                                                <img src={{asset("front/images/blog/img-02.jpg")}} alt="image description">
                                            </a>
                                            <figcaption>
                                                <ul class="tg-postmetadata">
                                                    <li><a href="#">by admin</a></li>
                                ...
                                <div class="tg-toprated">
                                    <ul>
                                        <li>
                                            <figure>
                                                <a href="#">
                                                    <img src={{asset("front/images/thumbnails/img-04.jpg")}} alt="image description">
                                                </a>
                                            </figure>
                                        ...
                                        <li>
                                            <figure>
                                                <a href="#">
                                                    <img src={{asset("front/images/thumbnails/img-05.jpg")}} alt="image description">
                                                </a>
                                            </figure>
                                            <div class="tg-productcontent">
                                                <h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
                                        ...
                                        <li>
                                            <figure>
                                                <a href="#">
                                                    <img src={{asset("front/images/thumbnails/img-06.jpg")}} alt="image description">
                                                </a>
                                            </figure>
                                            <div class="tg-productcontent">
                                                <h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
                                        ...
                                        <li>
                                            <figure>
                                                <a href="#">
                                                    <img src={{asset("front/images/thumbnails/img-07.jpg")}} alt="image description">
                                                </a>
                                            </figure>
                                            <div class="tg-productcontent">
                                                <h4><a href="#">Smooth 3-Stripes Scarf</a></h4><span class="tg-stars"><span></span></span>
                        ...
                        <div class="col-sm-4">
                            <div class="tg-footercol">
                                <div class="tg-haslayout">
                                    <strong class="tg-logo">
                                        <a href="#">
                                            <img src={{asset("front/images/logo2.png")}} alt="image description">
                                        </a>
                                    </strong>
                                </div>
                                <div class="tg-description">
...
<script src={{asset("front/js/customScrollbar.min.js")}}></script>
